...
def test_sub_element():
   ...
   #  page.append(P("A simple paragraph of text"))
    # page.append("Some more plain text.")
     page = Html("")
     body = Body("")
     body.append(P("some plain text."))
     body.append(P("Some more plain text."))
     page.append(body)
...
def test_attributes():
    e = P("A paragraph of text",style="text-align: center; font-style: oblique;")
   ...
   # print(file_contents)
    ...
    assert "font-style: oblique;" in file_contents
    assert file_contents[:-1].index(">") > file_contents.index("font-style: oblique;")
